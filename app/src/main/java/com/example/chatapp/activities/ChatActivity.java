...
public class ChatActivity extends BaseActivity {
    ...
    private void listenAvailabilityOfReceiver() {
        database.collection(Constants.KEY_COLLECTION_USERS).document(
            ...
            if (isReceiverAvailable) {
                binding.textAvailability.setBackgroundResource(R.drawable.background_availability_green);
            } else {
                binding.textAvailability.setBackgroundResource(R.drawable.background_availability_gray);
            }
        });
    }
